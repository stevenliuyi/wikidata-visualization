export const info = {
  ...
  'no-region':
    'The region items are not supported entities in the chosen region "[TEXT]".',
  ...
  'negative-height':
    'Canvas space is not enough. Please consider decreasing the padding size or increasing the canvas height.',
  'one-time':
